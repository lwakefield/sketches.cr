...
num_circles = (get_arg("num-circles") || "4").to_u32
out_file = (get_arg("out-file") || "out.png")

canvas = Canvas.new(width, height)
pixels = Array.new(height) do
        Array.new(width).fill(0f32)
end

points = [] of Tuple(Int32, Int32, Float32)
num_circles.times do
        circle(rand(10...width-10), rand(10...height-10), rand(10..width-10)) do |x, y|
                points << { x, y, rand(light_power) }
        end
end
